...
def get_questions() -> Dataset:
    data = load_dataset('parquet', data_files='data/ToM_2k.parquet')['train']
...
model_name = "outputs/Qwen-0.5B-GRPO-Tom-FT-WS/checkpoint-276"
...
if "Llama" in model_name:
    ...
    output_dir="outputs/Qwen-0.5B-GRPO-TomC-FT-WS"
    run_name="Qwen-0.5B-GRPO-TomC-FT-WS-384"
