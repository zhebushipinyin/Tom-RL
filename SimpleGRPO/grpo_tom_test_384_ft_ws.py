...
def get_questions() -> Dataset:
    data = load_dataset('parquet', data_files='data/cleaned_train_ft_with_structure_384.parquet', split='train[:25%]')
...
def reward_func_old(response, answer):
...
if "Llama" in model_name:
    ...
    output_dir="outputs/Qwen-0.5B-GRPO-Tom-FT-WS"
    run_name="Qwen-0.5B-GRPO-Tom-FT-WS-384"
