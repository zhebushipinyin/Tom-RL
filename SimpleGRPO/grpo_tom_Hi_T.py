...
def get_questions() -> Dataset:
    data = load_dataset('parquet', data_files='data/train/ToM_train.parquet')['train']
    return data
...
def reward_func_(response, answer):
    ...
    if match:
        ...
        think = extract_xml_think(response)
        len_reward = 0
        # think 20 words
...
if "Llama" in model_name:
    ...
    output_dir="outputs/Qwen-0.5B-GRPO-HI-T"
    run_name="Qwen-0.5B-GRPO-HI-T"
