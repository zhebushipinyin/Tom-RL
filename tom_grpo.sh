...
do
    ...
    do
        python3 -m verl.trainer.main_ppo \
            ...
            data.train_files=$HOME/data/tom/explore_tom/explore_tom_train_600_both.parquet \
            ...
            trainer.experiment_name="$(basename $model_name)-$lr" \
            trainer.n_gpus_per_node=$NUM_GPUS \
            trainer.nnodes=1 \
            trainer.default_hdfs_dir=null \
            trainer.save_freq=50 \
            trainer.test_freq=10 \
            trainer.total_epochs=2 $@ 2>&1 | tee tom_grpo_${model_name}_${lr}.log
    done
done
